...
function createProposal(string calldata title, string calldata description, uint256 durationSeconds) external onlyAdmin returns (uint256) {
...
function proposalSummary(uint256 id) external view returns (
uint256 pid,
string memory title,
